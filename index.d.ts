...
/* tslint:disable */
declare module 'Magento_PageBuilder/js/config-field.types' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type-config.types' {
	 ...
	 * See COPYING.txt for license details.
	 */
	import ConfigFieldInterface from 'Magento_PageBuilder/js/config-field.types';
	/**
	 * @api
	 */
...
declare module 'Magento_PageBuilder/js/data-store' {
	...
	export default class DataStore {
	     ...
	     */
	    get(key?: string): DataObject | undefined | null | string | number | boolean | any[];
	    /**
	     ...
	     */
	    update(data: DataObject | undefined | null | string | number | boolean | any[], key?: string | number): void;
	    /**
	     ...
	     * @param {string | number} key
	     */
	    subscribe(handler: (state: DataObject, event: Event) => void, key?: string | number): void;
	    /**
...
declare module 'Magento_PageBuilder/js/config' {
	...
	export default class Config {
	     ...
	     * @returns {any}
	     */
	    static getContentTypeConfig(contentType: string): ContentTypeConfigInterface;
...
declare module 'Magento_PageBuilder/js/content-type/appearance-config' {
	 ...
	 * @api
	 */
	export default function getAppearanceConfig(contentType: string, appearance: string): ContentTypeConfigAppearanceInterface;

}
declare module 'Magento_PageBuilder/js/content-type/observable-object' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/converter/converter-pool' {
	 ...
	 * See COPYING.txt for license details.
	 */
	import ConverterInterface from 'Magento_PageBuilder/js/converter/converter-interface'; class ConverterPool {
	    private converters;
	    /**
...
declare module 'Magento_PageBuilder/js/mass-converter/converter-pool' {
	 ...
	 * See COPYING.txt for license details.
	 */
	import ConverterInterface from 'Magento_PageBuilder/js/mass-converter/converter-interface'; class DataConverterPool {
	    private converters;
	    /**
...
declare module 'Magento_PageBuilder/js/drag-drop/move-content-type' {
	 ...
	 */
	export function moveContentType(contentType: ContentTypeInterface | ContentTypeCollectionInterface, targetIndex: number, targetParent?: ContentTypeCollectionInterface): void;
...
declare module 'Magento_PageBuilder/js/utils/array' {
	 ...
	 * @returns {Array<any>}
	 */
	export function moveArrayItem(array: any[] | KnockoutObservableArray<any>, fromIndex: number, toIndex: number): any[] | KnockoutObservableArray<any>;
	/**
	 ...
	 * @returns {Array<any>}
	 */
	export function moveArrayItemIntoArray(item: any, array: any[] | KnockoutObservableArray<any>, toIndex: number): any[] | KnockoutObservableArray<any>;
	/**
	 ...
	 * @returns {Array<any>}
	 */
	export function removeArrayItem(array: any[] | KnockoutObservableArray<any>, item: any): any[] | KnockoutObservableArray<any>;
	/**
	 ...
	 * @api
	 */
	export function outwardSearch(items: any[], start: number, callback: (item: any, index: number) => boolean): any;
...
declare module 'Magento_PageBuilder/js/collection' {
	...
	export default class Collection {
	    children: KnockoutObservableArray<ContentTypeInterface | ContentTypeCollectionInterface>;
	     ...
	     * @param children
	     */
	    setChildren(children: KnockoutObservableArray<ContentTypeInterface | ContentTypeCollectionInterface>): void;
	}
...
declare module 'Magento_PageBuilder/js/content-type/content-type-mount-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/observable-updater-factory' {
	 ...
	 */
	export default function create(config: ContentTypeConfigInterface, converterResolver: (config: object) => string): Promise<ObservableUpdater>;
...
declare module 'Magento_PageBuilder/js/content-type/master-factory' {
	 ...
	 */
	export default function create(contentType: ContentTypeInterface, config: ContentTypeConfigInterface): Promise<Master | MasterCollection>;
...
declare module 'Magento_PageBuilder/js/content-type/preview-factory' {
	 ...
	 * @returns {Promise<ContentTypeInterface>}
	 */
	export default function create(contentType: ContentTypeInterface, config: ContentTypeConfigInterface): Promise<Preview | PreviewCollection>;

}
declare module 'Magento_PageBuilder/js/field-defaults' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
	 ...
	 * @api
	 */
	export default interface FieldDefaultsInterface {
	    [key: string]: any;
	}
...
declare module 'Magento_PageBuilder/js/content-type-factory' {
	 ...
	 * @api
	 */
	export default function createContentType(config: ContentTypeConfigInterface, parent: ContentTypeCollectionInterface, stageId: string, data?: object, childrenLength?: number): Promise<ContentTypeInterface | ContentTypeCollectionInterface>;
...
declare module 'Magento_PageBuilder/js/content-type/preview-collection' {
	...
	export default class PreviewCollection extends Preview {
	     ...
	     * @returns {string}
	     */
	    readonly previewChildTemplate: string;
	    /**
	     ...
	     */
	    clone(contentType: ContentTypeCollectionInterface, autoAppend?: boolean, direct?: boolean): Promise<ContentTypeCollectionInterface> | void;
	    /**
...
declare module 'Magento_PageBuilder/js/content-type-collection' {
	...
	import MasterCollection from 'Magento_PageBuilder/js/content-type/master-collection';
	import PreviewCollection from 'Magento_PageBuilder/js/content-type/preview-collection';
	export default class ContentTypeCollection<P extends PreviewCollection = PreviewCollection, M extends MasterCollection = MasterCollection> extends ContentType<P, M> implements ContentTypeCollectionInterface<P, M> {
	    private collection;
	    /**
	     * @param {ContentTypeInterface} parent
	     * @param {ContentTypeConfigInterface} config
	     ...
	     */
	    constructor(parent: ContentTypeCollectionInterface, config: ContentTypeConfigInterface, stageId: string);
	    /**
	     * Return the children of the current element
	     *
	     * @returns {KnockoutObservableArray<ContentTypeInterface | ContentTypeCollectionInterface>}
...
declare module 'Magento_PageBuilder/js/content-type-menu/option-config' {
	import Preview from 'Magento_PageBuilder/js/content-type/preview';
...
declare module 'Magento_PageBuilder/js/content-type-menu/option.types' {
	...
	/// <reference types="knockout" />
	import Preview from 'Magento_PageBuilder/js/content-type/preview';
	import OptionConfigInterface from 'Magento_PageBuilder/js/content-type-menu/option-config';
	/**
	 * @api
	 */
...
declare module 'Magento_PageBuilder/js/content-type-menu' {
	 ...
	 * See COPYING.txt for license details.
	 */
	import OptionInterface, { OptionsInterface } from 'Magento_PageBuilder/js/content-type-menu/option.types';
	import Preview from 'Magento_PageBuilder/js/content-type/preview';
	/**
	 * @api
	 */
...
declare module 'Magento_PageBuilder/js/content-type-menu/option' {
	...
	import Preview from 'Magento_PageBuilder/js/content-type/preview';
	import OptionConfigInterface from 'Magento_PageBuilder/js/content-type-menu/option-config';
	import OptionInterface from 'Magento_PageBuilder/js/content-type-menu/option.types';
...
declare module 'Magento_PageBuilder/js/content-type-removed-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/drag-drop/allowed-parents' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/drag-drop/matrix' {
	 ...
	 * @returns {string}
	 */
	export function getAllowedContainersClasses(contentType: string, stageId: string): string;
...
declare module 'Magento_PageBuilder/js/master-format/render' {
	...
	export default class MasterFormatRenderer {
	     ...
	     */
	    applyBindings(rootContainer: ContentTypeCollectionInterface): Promise<string>;
	}
...
declare module 'Magento_PageBuilder/js/drag-drop/drop-indicators' {
	 ...
	 * @returns {HTMLStyleElement}
	 */
	export function showDropIndicators(contentType: string, stageId: string): HTMLStyleElement;
	/**
...
declare module 'Magento_PageBuilder/js/stage-toggle-full-screen-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/page-builder' {
	...
	import StageToggleFullScreenParamsInterface from 'Magento_PageBuilder/js/stage-toggle-full-screen-params';
...
declare module 'Magento_PageBuilder/js/panel/group' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/panel/group/content-type' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/stage-update-after-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/preview' {
	...
	import ContentTypeInterface from 'Magento_PageBuilder/js/content-type.types';
	import { DataObject } from 'Magento_PageBuilder/js/data-store';
	import ObservableObject from 'Magento_PageBuilder/js/content-type/observable-object.d';
	import ObservableUpdater from 'Magento_PageBuilder/js/content-type/observable-updater';
	/**
	 * @api
	 */
	export default class Preview {
	     ...
	     */
	    constructor(parent: ContentTypeInterface, config: ContentTypeConfigInterface, observableUpdater: ObservableUpdater);
	    /**
	     ...
	     */
	    clone(contentType: ContentTypeInterface | ContentTypeCollectionInterface, autoAppend?: boolean, direct?: boolean): Promise<ContentTypeInterface> | void;
	    /**
	     ...
	     * @param {boolean} direct
	     */
	    protected dispatchContentTypeCloneEvents(originalContentType: ContentTypeInterface, duplicateContentType: ContentTypeInterface, index: number, direct: boolean): void;
	    /**
	     * Bind events
	     */
...
declare module 'Magento_PageBuilder/js/content-type/observable-updater' {
	...
	export default class ObservableUpdater {
	     ...
	     */
	    constructor(converterPool: typeof ConverterPool, massConverterPool: typeof MassConverterPool, converterResolver: (config: object) => string);
	    /**
...
declare module 'Magento_PageBuilder/js/content-type/master' {
	...
	export default class Master {
	     ...
	     * @param {ObservableUpdater} observableUpdater
	     */
	    constructor(parent: ContentTypeInterface, observableUpdater: ObservableUpdater);
	    /**
...
declare module 'Magento_PageBuilder/js/content-type-collection.types' {
	...
	import MasterCollection from 'Magento_PageBuilder/js/content-type/master-collection';
	import PreviewCollection from 'Magento_PageBuilder/js/content-type/preview-collection';
	export default interface ContentTypeCollectionInterface<P extends PreviewCollection = PreviewCollection, M extends MasterCollection = MasterCollection> extends ContentTypeInterface<P, M> {
...
declare module 'Magento_PageBuilder/js/content-type' {
	...
	import Preview from 'Magento_PageBuilder/js/content-type/preview';
	import DataStore from 'Magento_PageBuilder/js/data-store';
	export default class ContentType<P extends Preview = Preview, M extends Master = Master> implements ContentTypeInterface<P, M> {
	    id: string;
	    parent: ContentTypeCollectionInterface;
	    stageId: string;
	    config: ContentTypeConfigInterface;
...
declare module 'Magento_PageBuilder/js/content-type-move-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/binding/active-options' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/binding/placeholder-options' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/binding/sortable-options' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */

	import {PlaceholderOptionsInterface} from 'Magento_PageBuilder/js/binding/placeholder-options';
	/**
	 * @api
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-after-render-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-before-move-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-create-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-dropped-create-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-duplicate-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-move-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-ready-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-redraw-after-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/content-type-removed-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/preview-data-update-after-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/column/resize' {
	 ...
	 */
	import ContentTypeCollectionInterface from 'Magento_PageBuilder/js/content-type-collection.types';
	import { ColumnWidth, GroupPositionCache, MaxGhostWidth, ResizeHistory } from 'Magento_PageBuilder/js/content-type/column-group/preview';
	...
	export default class Resize {
	     ...
	     * @returns {number}
	     */
	    getColumnWidth(column: ContentTypeCollectionInterface<ColumnPreview>): number;
	    /**
	     ...
	     * @returns {ColumnWidth[]}
	     */
	    determineColumnWidths(column: ContentTypeCollectionInterface<ColumnPreview>, groupPosition: GroupPositionCache): ColumnWidth[];
	    /**
	     ...
	     */
	    findShrinkableColumnForResize(column: ContentTypeCollectionInterface<ColumnPreview>, direction: "left" | "right"): ContentTypeCollectionInterface<ColumnPreview>;
	    /**
	     ...
	     * @returns {ContentTypeCollectionInterface<ColumnPreview>}
	     */
	    findShrinkableColumn(column: ContentTypeCollectionInterface<ColumnPreview>): ContentTypeCollectionInterface<ColumnPreview>;
	    /**
	     ...
	     * @returns {number}
	     */
	    calculateGhostWidth(groupPosition: GroupPositionCache, currentPos: number, column: ContentTypeCollectionInterface<ColumnPreview>, modifyColumnInPair: string, maxGhostWidth: MaxGhostWidth): number;
	    /**
	     ...
	     */
	    determineAdjustedColumn(currentPos: number, column: ContentTypeCollectionInterface<ColumnPreview>, history: ResizeHistory): [ContentTypeCollectionInterface<ColumnPreview>, string, string];
	    /**
	     ...
	     */
	    resizeColumn(column: ContentTypeCollectionInterface<ColumnPreview>, width: number, shrinkableColumn: ContentTypeCollectionInterface<ColumnPreview>): void;
	    /**
	 ...
	 */
	export function getAdjacentColumn(column: ContentTypeCollectionInterface<ColumnPreview>, direction: "+1" | "-1"): ContentTypeCollectionInterface<ColumnPreview>;
	/**
...
declare module 'Magento_PageBuilder/js/content-type/column-group/grid-size' {
	 ...
	 */
	export function resizeGrid(columnGroup: ContentTypeCollectionInterface<ColumnGroupPreview>, newGridSize: number, gridSizeHistory: Map<number, number[]>): void;
...
declare module 'Magento_PageBuilder/js/content-type/column/preview' {
	...
	export default class Preview extends PreviewCollection {
	     ...
	     * @returns {Promise<ContentTypeCollectionInterface> | void}
	     */
	    clone(contentType: ContentTypeCollectionInterface<Preview>, autoAppend?: boolean): Promise<ContentTypeCollectionInterface> | void;
	    /**
...
declare module 'Magento_PageBuilder/js/content-type/column/init-element-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type/column-group/factory' {
	 ...
	 * @returns {Promise<ContentTypeCollectionInterface>}
	 */
	export function createColumn(parent: ContentTypeCollectionInterface, width: number, index?: number): Promise<ContentTypeCollectionInterface<ColumnPreview>>;
...
declare module 'Magento_PageBuilder/js/content-type/column-group/registry' {
	 ...
	 * @param {ContentTypeCollectionInterface<ColumnPreview>} column
	 */
	export function setDragColumn(column: ContentTypeCollectionInterface<ColumnPreview>): void;
...
declare module 'Magento_PageBuilder/js/content-type/column-group/preview' {
	...
	export default class Preview extends PreviewCollection {
	     ...
	     * @param {ObservableUpdater} observableUpdater
	     */
	    constructor(parent: ColumnGroup, config: ContentTypeConfigInterface, observableUpdater: ObservableUpdater);
	    /**
	     ...
	     */
	    onColumnSort(column: ContentTypeCollectionInterface<ColumnPreview>, newIndex: number): void;
	    /**
	     ...
	     */
	    onColumnResize(column: ContentTypeCollectionInterface<ColumnPreview>, width: number, adjustedColumn: ContentTypeCollectionInterface<ColumnPreview>): void;
	    /**
	     ...
	     * @param {JQuery} handle
	     */
	    registerResizeHandle(column: ContentTypeCollectionInterface<ColumnPreview>, handle: JQuery): void;
	    /**
...
declare module 'Magento_PageBuilder/js/content-type/column/bind-resize-handle-event-params' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
	...
	export default interface BindResizeHandleEventParamsInterface {
	    column: ContentTypeCollectionInterface<ColumnPreview>;
	    handle: JQuery;
	    parent: ContentTypeCollectionInterface<ColumnGroupPreview>;
	}
...
declare module 'Magento_PageBuilder/js/content-type-toolbar/value' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */
...
declare module 'Magento_PageBuilder/js/content-type-toolbar/option' {
	/**
	 * Copyright © Magento, Inc. All rights reserved.
	 * See COPYING.txt for license details.
	 */

	import ValueInterface from 'Magento_PageBuilder/js/content-type-toolbar/value.d';
...
declare module 'Magento_PageBuilder/js/content-type-toolbar' {
	 ...
	 */
	/// <reference types="knockout" />
	import { OptionInterface } from 'Magento_PageBuilder/js/content-type-toolbar/option';
	import ValueInterface from 'Magento_PageBuilder/js/content-type-toolbar/value';
	import Preview from 'Magento_PageBuilder/js/content-type/preview';
	/**
	 * @api
	 */
...
declare module 'Magento_PageBuilder/js/uploader' {
	...
	export default class Uploader {
	     ...
	     */
	    constructor(name: string, uploaderConfig: object, contentTypeId: string, dataStore: DataStore, initialValue: string | any[], onChangeCallback?: (data: object[]) => void, onDeleteCallback?: () => void);
	    /**
...
declare module 'Magento_PageBuilder/js/wysiwyg/wysiwyg-interface' {
	 ...
	 */
	export type WysiwygConstructorInterface = new (contentTypeId: string, elementId: string, config: AdditionalDataConfigInterface, dataStore: DataStore, fieldName: string) => WysiwygInterface;
	/**
...
declare module 'Magento_PageBuilder/js/wysiwyg/tinymce4' {
	...
	export default class Wysiwyg implements WysiwygInterface {
	     ...
	     */
	    constructor(contentTypeId: string, elementId: string, config: AdditionalDataConfigInterface, dataStore: DataStore, fieldName: string);
	    /**
...
declare module 'Magento_PageBuilder/js/wysiwyg/factory' {
	 ...
	 * @returns {Wysiwyg}
	 */
	export default function create(contentTypeId: string, elementId: string, contentTypeName: string, config: AdditionalDataConfigInterface, dataStore: DataStore, fieldName: string): Promise<WysiwygInterface>;
...
declare module 'Magento_PageBuilder/js/mass-converter/widget-directive-abstract' {
	 ...
	 * See COPYING.txt for license details.
	 */
	import ConverterInterface, { ConverterConfigInterface, ConverterDataInterface } from 'Magento_PageBuilder/js/mass-converter/converter-interface';
	export default class WidgetDirectiveAbstract implements ConverterInterface {
	     ...
	     */
	    fromDom(data: ConverterDataInterface, config: ConverterConfigInterface): WidgetDirectiveAttributes;
	    /**
	     * Convert value to knockout format
	     *
	     * @param {ConverterDataInterface} data
...
declare module 'Magento_PageBuilder/js/content-type/block/mass-converter/widget-directive' {
	 ...
	 * See COPYING.txt for license details.
	 */
	import { ConverterConfigInterface, ConverterDataInterface } from 'Magento_PageBuilder/js/mass-converter/converter-interface';
...
declare module 'Magento_PageBuilder/js/utils/delay-until' {
	 ...
	 */
	export default function delayUntil(callback: () => void, condition: () => boolean, interval?: number): void;
...
declare module 'Magento_PageBuilder/js/content-type/buttons/preview' {
	 ...
	 */
	/// <reference types="knockout" />
	import { SortableOptionsInterface } from 'Magento_PageBuilder/js/binding/sortable-options';
	import ContentTypeCollectionInterface from 'Magento_PageBuilder/js/content-type-collection.types';
	import ContentTypeConfigInterface from 'Magento_PageBuilder/js/content-type-config.types';
	import { OptionsInterface } from 'Magento_PageBuilder/js/content-type-menu/option.types';
	import ObservableUpdater from 'Magento_PageBuilder/js/content-type/observable-updater';
	...
	export default class Preview extends PreviewCollection {
	     ...
	     * @param {ObservableUpdater} observableUpdater
	     */
	    constructor(parent: ContentTypeCollectionInterface, config: ContentTypeConfigInterface, observableUpdater: ObservableUpdater);
	    /**
	     * Bind events
	     */
	    bindEvents(): void;
	     ...
	     */
	    getSortableOptions(orientation?: string, tolerance?: string): SortableOptionsInterface;
	    /**
...
declare module 'Magento_PageBuilder/js/content-type/heading/preview' {
	...
	import ContentTypeConfigInterface from 'Magento_PageBuilder/js/content-type-config.types';
	import { OptionsInterface } from 'Magento_PageBuilder/js/content-type-menu/option.types';
	import Toolbar from 'Magento_PageBuilder/js/content-type-toolbar';
	import ContentTypeInterface from 'Magento_PageBuilder/js/content-type.types';
	import ObservableUpdater from 'Magento_PageBuilder/js/content-type/observable-updater';
	import BasePreview from 'Magento_PageBuilder/js/content-type/preview';
	/**
...
declare module 'Magento_PageBuilder/js/content-type/slider/preview' {
	...
	export default class Preview extends PreviewCollection {
	     ...
	     * @param {boolean} force
	     */
	    navigateToSlide(slideIndex: number, dontAnimate?: boolean, force?: boolean): void;
	    /**
	     ...
	     * operation
	     */
	    onSortStop(event: JQueryEventObject, params: JQueryUI.SortableUIParams): void;
	    /**
...
declare module 'Magento_PageBuilder/js/content-type/tabs/preview' {
	...
	import { SortableOptionsInterface } from 'Magento_PageBuilder/js/binding/sortable-options.d';
	import ContentTypeCollectionInterface from 'Magento_PageBuilder/js/content-type-collection.types';
	import ContentTypeConfigInterface from 'Magento_PageBuilder/js/content-type-config.types';
	import { OptionsInterface } from 'Magento_PageBuilder/js/content-type-menu/option.types';
	import ObservableUpdater from 'Magento_PageBuilder/js/content-type/observable-updater';
	...
	export default class Preview extends PreviewCollection {
	     ...
	     */
	    refreshTabs(focusIndex?: number, forceFocus?: boolean, activeIndex?: number): void;
	    /**
...
declare module 'Magento_PageBuilder/js/content-type/tabs/mass-converter/header-alignment' {
	 ...
	 * See COPYING.txt for license details.
	 */
	import MassConverterInterface, { ConverterConfigInterface, ConverterDataInterface } from 'Magento_PageBuilder/js/mass-converter/converter-interface';
...
declare module 'Magento_PageBuilder/js/utils/loader' {
	 ...
	 * See COPYING.txt for license details.
	 */
	export default function load(dependencies: string[], factory: (...results: any[]) => void, onError?: () => void): void;
